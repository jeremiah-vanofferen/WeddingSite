-- Database initialization for wedding website
-- Create tables for guests and admin users
...
-- Create settings table for admin email and other global settings
...
INSERT INTO settings (key, value) VALUES ('adminEmail', 'your@email.com') ON CONFLICT (key) DO NOTHING;
...
INSERT INTO settings (key, value) VALUES ('fontFamily', 'serif') ON CONFLICT (key) DO NOTHING;
...
-- Password hash for 'Wedding8826' using bcrypt with 10 rounds
